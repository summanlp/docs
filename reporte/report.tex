...
\begin{abstract}
Este reporte describe el desarrollo y prueba de nuevas variantes del algoritmo
...
En la siguiente sección se describen las diferentes variantes que se probaron sobre el algoritmo original de
TextRank, principalmente estas modificaciones apuntan a cambiar la forma en la cual se calculan las distancias entre las oraciones de los textos. Diferentes métricas arrojaron diferentes resultados y algunas de éstas métricas lograron una mejora significativa sobre el algoritmo original.
